...
def get_client_class(base_pubsub_client_module):
    ...
    if base_pubsub_client_module.__name__ == CLIENT.PUBSUB.BASE_CLIENTS.PAHO_MQTT.MODULE_NAME:
        from ams.clients.pubsub.paho_mqtt import PubSubClient
    ...
    elif base_pubsub_client_module.__name__ == CLIENT.PUBSUB.BASE_CLIENTS.ROS_NODE.MODULE_NAME:
        from ams.clients.pubsub.ros_node import PubSubClient
