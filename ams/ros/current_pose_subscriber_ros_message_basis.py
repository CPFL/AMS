...
from ams.structures import CURRENT_POSE_SUBSCRIBER, AUTOWARE_VOICE_RECOGNITION
...
class CurrentPoseSubscriber(EventLoop):
    ...
    def __init__(self, _id, period):
        ...
        self.__topicPubCurrentPose.set_targets(
            self.target, Target.new_target(self.target.id, AUTOWARE_VOICE_RECOGNITION.NODE_NAME)
        )
