...
from ams.structures import STATE_COMMAND_PUBLISHER, AUTOWARE_VOICE_RECOGNITION
...
class StateCommandPublisher(EventLoop):
    ...
    def __init__(self, _id):
        ...
        self.__topicSubStateCommand.set_targets(
            Target.new_target(self.target.id, AUTOWARE_VOICE_RECOGNITION.NODE_NAME), self.target
        )
        self.__topicSubStateCommand.set_categories(AUTOWARE_VOICE_RECOGNITION.TOPIC.CATEGORIES.STATE_COMMAND)
