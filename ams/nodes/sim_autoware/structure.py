...
dicision_maker_state_template = {
    "data": "state"
}

dicision_maker_state_schema = {
    "data": {
        "type": "string",
        "required": True,
        "nullable": False
...
class DecisionMakerState(get_structure_superclass(dicision_maker_state_template, dicision_maker_state_schema)):
    pass
...
status_template = {
    "lane_waypoints_array": LaneArray.get_template(),
