...
from ams.messages import user_message, vehicle_message, traffic_signal_message
...
class FleetManager(EventLoop):
    def __init__(self, waypoint, arrow, route):
        ...
        # self.set_subscriber(CONST.TOPICS.FLEET_STATUS)
    ...
    def dispatch(self, user_id, user_status):
        start_point = {
            "arrow_id": self.arrow.get_arrow_ids_from_waypoint_id(
        ...
        for vehicle_id, goal_waypoint_id in map(
            ...
            goal_points.append({
                "goal_id": vehicle_id,
                "arrow_id": self.arrow.get_arrow_ids_from_waypoint_id(goal_waypoint_id)[0],
        ...
        goal_points = [{
            "goal_id": user_id,
            "arrow_id": self.arrow.get_arrow_ids_from_waypoint_id(user_status["schedules"][0]["goal"]["waypoint_id"])[0],
        ...
        # print("dispatch", self.vehicles[vehicle_id])
        # if self.vehicles[vehicle_id]["schedules"][-1]["action"] == SimTaxi.STATE.STANDBY:
        #     self.vehicles[vehicle_id]["schedules"].pop()
        current_time = time()
        ...
        vehicle_schedule.update({
            ...
            "route": {
                ...
                "arrow_ids": pick_up_route["arrow_ids"],
            }
        })
        ...
        vehicle_schedule.update({
            ...
            "route": {
                ...
                "arrow_ids": carry_route["arrow_ids"],
            }
        })
        self.vehicles[vehicle_id]["schedules"].append(vehicle_schedule)
    ...
    # def publish_fleet_status(self, message):
    #     if message == "":
